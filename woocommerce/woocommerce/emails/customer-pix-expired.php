<?php
/**
 * Customer PIX expired email
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/customer-pix-expired.php.
 *
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <div id="body_content_inner">
                                                            ...
                                                            <p><?php esc_html_e( 'Caso você tenha pago seu pedido, entre em contato com o suporte.', 'wc-piggly-pix' ); ?></p>
