...
<?php if ( $email_improvements_enabled ) : ?>
	<p><?php esc_html_e( 'Processamos seu pedido com sucesso e ele está a caminho.', 'woocommerce' ); ?></p>
	<p><?php esc_html_e( 'Aqui está um lembrete do que você pediu:', 'woocommerce' ); ?></p>
<?php else : ?>
	<p><?php esc_html_e( 'Finalizamos o processamento do seu pedido.', 'woocommerce' ); ?></p>
<?php endif; ?>
