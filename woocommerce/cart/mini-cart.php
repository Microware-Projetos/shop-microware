...
<?php if ( WC()->cart && ! WC()->cart->is_empty() ) : ?>
	...
	<p class="woocommerce-mini-cart__buttons buttons">
		<a href="<?php echo wc_get_cart_url(); ?>" class="btn btn-primary mobile-cart-btn"><?php echo esc_html_e('Cart','storebiz'); ?></a>
		<a href="<?php echo wc_get_checkout_url(); ?>" class="btn btn-primary mobile-checkout-btn"><?php echo esc_html_e('Checkout','storebiz'); ?></a>
	</p>
